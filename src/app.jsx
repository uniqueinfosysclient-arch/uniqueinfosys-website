...
export function Hero() {
  return (
    <section className="hero-bg hero-grid hero-top-pad relative min-h-screen flex flex-col justify-center overflow-hidden pb-20 sm:pb-24" aria-labelledby="hero-heading">
      <FloatingShapes />
